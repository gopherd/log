...
func _() {
	...
	log.Debug().String("key", "value")             // want: result of (*github.com/gopherd/log.Recorder).String call not used
	log.Debug().Int("i", 1).String("key", "value") // want: result of (*github.com/gopherd/log.Recorder).String call not used
